 ...
 */
  ...
  #define MESH_MIN_X 54//MESH_INSET //54!
  #define MESH_MIN_Y 10//MESH_INSET //10
  #define MESH_MAX_X X_BED_SIZE //- (MESH_INSET) //just 1. part
  #define MESH_MAX_Y Y_BED_SIZE -10// (MESH_INSET) //just 1. -10
#endif
